...
const ClubTrackerComponent = (props: iObject) => {
  return (
    ...
    <div className='grid grid-cols-5  pt-3 ml-28 '>
      <div className='truncate'><p>{props.name}</p></div>
      <div className='ml-[17%] truncate'><p>{props.stock}</p></div>
      <div className='ml-[30%] truncate'><p>{props.max}</p></div>
      <div className='text-center truncate'><p>{props.confidence}</p></div>
